...
const ProjectCard = ({ title, views }: { title: string; views: string }) => (
  <div className="group cursor-pointer transition-all duration-500 hover:scale-[1.03]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            <div className="lg:col-span-8 space-y-10">
              <div className="bg-[#080808] border border-white/5 rounded-[2.5rem] p-10">
                ...
                <p className="text-[15px] text-white/40 leading-[1.8] font-medium"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique totam voluptatum obcaecati ab nulla? Rem animi possimus, numquam obcaecati minima autem. Libero vel veniam officiis laboriosam explicabo eveniet dolorem at.
                Ab, veritatis totam. Mollitia nobis, provident sapiente consectetur nulla, beatae nesciunt nihil quibusdam quisquam illo atque accusamus voluptatem ducimus illum.</p>
              </div>
              <div className="bg-[#080808] border border-white/5 rounded-[2.5rem] p-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {['React.js', 'Next.js', 'Tailwind CSS', 'TypeScript'].map(s => (
                    <span key={s} className="bg-white/5 px-6 py-2.5 rounded-xl text-[9px] text-white/30 font-bold uppercase tracking-widest hover:bg-white/10 transition-colors">{s}</span>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="flex justify-between items-center text-[13px] font-bold capitalize tracking-widest">
                <span className="text-white/20">Completion of projects</span>
                <span className="text-white/80">33.33%</span>
              </div>
              <div className="flex justify-between items-center text-[13px] font-bold capitalize tracking-widest">
                <span className="text-white/20">Delivery on time</span>
                <span className="text-white/80">33.33%</span>
              </div>
              <div className="flex justify-between items-center text-[13px] font-bold capitalize tracking-widest">
                <span className="text-white/20">Average response speed</span>
        ...
        <section ref={projectsRef} className="mb-32 scroll-mt-32">
          <div className="flex justify-between items-center mb-12 px-2">
              <h3 className="text-[11px] font-black tracking-[0.3em] text-white uppercase border-l-2 border-emerald-500 pl-4">My Projects</h3>
              <button className="text-[9px] bg-[#111] text-white/40 border border-white/5 px-6 py-2.5 rounded-xl font-black uppercase tracking-widest hover:text-white transition-all">Add Project</button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
              <ProjectCard title="PUERI Nursery Care (Mobile App)" views="200" />
              <ProjectCard title="PUERI Nursery Care (Mobile App)" views="200" />
              <ProjectCard title="PUERI Nursery Care (Mobile App)" views="200" />
          </div>
        </section>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-[#080808] border border-white/[0.03] rounded-[1.5rem] p-10">
              ...
              <div className="flex flex-col">
                <ReviewItem 
                  name="Alpha Tech Inc." 
                  project="Food Delivery App Development" 
                  date="2 weeks ago" 
                  comment="Excellent and very professional work. Ahmed met the deadlines and provided smooth, bug-free interfaces. Highly recommend working with him." 
                />
                <ReviewItem 
                  name="Cyber Group" 
                  project="Innovative UI Design" 
                  date="1 month ago" 
                  comment="Design details were translated with high precision. The user experience is great and the animations are professional." 
                />
                <ReviewItem 
                  name="Khalid Saeed" 
                  project="Dashboard Development" 
                  date="3 months ago" 
                  comment="Creative developer, responded to changes with an open mind. The code is very clean." 
                />
              </div>
            </div>
          </div>
